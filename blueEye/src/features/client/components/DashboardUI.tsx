...
const MOCK_ALERTS: DashboardAlert[] = [
  {
    ...
    description:
      "CAM-003 (Pasillo Norte) offline desde hace 18h. Ticket generado automáticamente.",
    time: "Hace 18h",
    source: "CAM-003",
  },
  {
    ...
    description:
      "NVR Principal al 87%. Revisar política de retención de grabaciones.",
    time: "Hace 3d",
    source: "NVR",
  },
  {
    ...
    description: "Visita técnica preventiva 25 feb entre 9:00–12:00 am.",
    time: "Hace 2d",
    source: "Sistema",
  },
];
...
const UPTIME_DATA = [
  92, 96, 100, 84, 100, 100, 96, 88, 100, 100, 94, 100, 100, 98, 100, 86, 100,
  100, 96, 100, 100, 88, 94, 100, 100, 100, 96, 98, 100, 100,
];
...
const StatCard: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 10, color: T.t3, fontFamily: T.font }}>
        {detail}
      </div>
      {barWidth && barFill && (
        <div
...
const AlertRow: React.FC<{ alert: DashboardAlert; isLast?: boolean }> = ({
  alert,
  isLast,
}) => {
    ...
    >
      ...
      {alerts.length > 0 && (
        ...
        >
          ...
          <Tag bg="#1A0A08" color="#A05040" border="#4A2018">
      ...
      >
        <StatCard
          ...
          dotColor={T.mint}
          barFill="#3D9664"
          barWidth={`${(online / cameras.length) * 100}%`}
          animDelay={40}
        />
        <StatCard
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        ...
        <Panel
          ...
          right={
            <Tag bg="#2A1510" color="#B06050" border="#3A1A14">
        ...
        <Panel
          ...
          right={
            <Tag bg={T.mintBg} color={T.mint} border={T.mintDim}>
              {online} / {cameras.length} activas
            </Tag>
          }
              ...
              {UPTIME_DATA.map((v, i) => {
                ...
                return (
                  <div
                    ...
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLDivElement).style.opacity = isLast
                        ? "1"
                        : "0.3";
                    }}
                  />
            ...
            <div style={{ display: "flex", gap: 16 }}>
              {(
                ...
                >
                  ...
                  />
                  <span
                    style={{ fontSize: 9, color: T.t3, fontFamily: T.mono }}
                  >
                    {l.label}
                  </span>
                </div>
