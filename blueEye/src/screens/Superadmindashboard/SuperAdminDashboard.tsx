...
// Fixed: removed Company entries that were incorrectly mixed into AuditEntry array
...
const planBadge = (plan: TipoPlan): React.ReactElement => {
  ...
  return (
    <span style={{ color: map[plan] ?? "#94a3b8", fontWeight: 700, fontSize: 12 }}>
      {plan}
    </span>
  );
};
...
// Fixed: removed duplicated JSX blocks and unclosed tags
function StatCard({ icon, label, value, sub, accent = "#22d3ee", trend }: StatCardProps): React.ReactElement {
  return (
    ...
    >
      ...
      <div style={{ fontSize: 30, fontWeight: 900, color: "#0f172a", fontFamily: "'Syne', sans-serif", lineHeight: 1 }}>
        {value}
      </div>
      <div style={{ fontSize: 13, fontWeight: 600, color: "#64748b", letterSpacing: "0.03em" }}>
        {label}
      </div>
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", background: "#f8fafc" }}>
      ...
      >
        <div style={{ padding: "28px 20px 24px", borderBottom: "1px solid rgba(34,211,238,0.07)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, color: "#f1f5f9", fontSize: 15, letterSpacing: "0.02em" }}>
                BlueEye
              </div>
              <div style={{ fontSize: 10, color: "#22d3ee", letterSpacing: "0.1em", fontWeight: 600, textTransform: "uppercase" }}>
                Super Admin
              </div>
            </div>
          </div>
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "auto" }}>
        ...
        >
          <div>
            <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 22, color: "#0f172a" }}>
              Dashboard Global
            </div>
            ...
            <div style={{ background: "#ffffff", border: "1px solid rgba(2,6,23,0.08)", borderRadius: 16, padding: 24, boxShadow: "0 12px 30px rgba(2,6,23,0.06)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                ...
                <button
                  ...
                  style={{ fontSize: 11, color: "#0ea5e9", background: "rgba(14,165,233,0.08)", border: "1px solid rgba(14,165,233,0.18)", borderRadius: 8, padding: "5px 12px", cursor: "pointer", fontWeight: 600 }}
                >
                  Ver todas →
                </button>
              </div>
            ...
            <div style={{ background: "#ffffff", border: "1px solid rgba(2,6,23,0.08)", borderRadius: 16, padding: 24, boxShadow: "0 12px 30px rgba(2,6,23,0.06)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                {auditLog.map((log, i) => (
                  <div
                    key={i}
                    style={{ display: "flex", gap: 12, padding: "12px 0", borderBottom: i < auditLog.length - 1 ? "1px solid rgba(2,6,23,0.06)" : "none", alignItems: "flex-start" }}
                  >
                    <div
                      style={{ width: 8, height: 8, borderRadius: "50%", background: tipoBullet[log.tipo], marginTop: 4, flexShrink: 0, boxShadow: `0 0 6px ${tipoBullet[log.tipo]}55` }}
                    />
                    <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
            {quickActions.map((a) => (
              <div
                ...
                style={{ background: "rgba(14,165,233,0.04)", border: "1px solid rgba(2,6,23,0.08)", borderRadius: 12, padding: "16px 18px", display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }}
              >
